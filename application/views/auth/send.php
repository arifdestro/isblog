    ...
    <div class="container px-5">
        <div class="row gx-5 align-items-center justify-content-center row-login border-end border-start">
            ...
            <div class="col-sm-12 col-md-5 mb-5 mt-5">
                ...
                <?= form_open('Auth/send', 'autocomplete="off"') ?>
                <h2 class="font-alt text-center card-judul2">Aktivasi Akun</h2>
                <p class="text-center card-judul2 mt-1 mb-4"><i class="fas fa-info-circle"></i> Masukkan email untuk aktivasi akun</p>
