    ...
    <div class="container px-5">
        <div class="row gx-5 align-items-center justify-content-center justify-content-lg-between">
            <div class="col-sm-12 col-md-12 col-lg-12">
                <span class="badge bg-dark lh-1 mb-2">Tag : <?= $hasil ?></span>
                <p class="lead fw-normal mb-4">Beberapa postingan terkait tag <?= $hasil ?>.</p>
                <ul class="nav">
                    ...
                    <li class="nav-item me-1 ms-0">
                        <a class="me-lg-3 mb-4 mb-lg-0 btn btn-sm btn-danger" href="<?= base_url('tag/' . strtolower($tg->permalink_tg)) ?>">#<?= $tg->nama_tag ?> (<?= count($tag) ?>) <i class="fas fa-chevron-down"></i></a>
                    </li>
                    <li class="nav-item me-1 ms-0">
                        <a class="me-lg-3 mb-4 mb-lg-0 btn btn-sm btn-primary" href="<?= base_url('tag') ?>">Selengkapnya <i class="fas fa-chevron-right"></i></a>
                    </li>
                </ul>
            </div>
